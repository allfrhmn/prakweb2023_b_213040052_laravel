...
@section('container')
    ...
    <div class="table-responsive col-lg-8">
        <a href="/dashboard/posts/create" class="btn btn-primary"><i class="bi bi-plus-circle"></i> Create new post</a>
            ...
            <tbody>
                @foreach ($posts as $post)
                    <tr>
                        ...
                        <td>
                            <a href="/dashboard/posts/{{ $post->slug }}" class="badge bg-info"><i class="bi bi-info-circle"></i></a>
